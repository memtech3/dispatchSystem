...
<template>
  <li class="dark:text-white dark:bg-gray-800 rounded-md">
    <div class="flex h-32">
      <div
      ...
      >
        <span
          class="inline-flex items-center justify-center w-10 h-10 text-2xl font-semibold text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300 mb-5"
        >
...
@mixin cardPriorityColor($color) {
  .priorityColor-#{$color} {
    @apply bg-#{$color}-100 dark:bg-#{$color}-400 text-gray-700 font-bold;
  }
}
